      ...
      <v-card-text class="mt-n2">
        <v-window v-model="tab" :touch="touchless()">
          <v-window-item value="one">
            <SectionMattress03Common :data="data1" :dataStore="dataStore" />
          </v-window-item>

          <v-window-item value="two">
            <SectionMattress03Common :data="data2" :dataStore="dataStore" />
          </v-window-item>

          <v-window-item value="three">
            <SectionMattress03Common :data="data3" :dataStore="dataStore" />
          </v-window-item>

          <v-window-item value="four">
            <SectionMattress03Common :data="data4" :dataStore="dataStore" />
          </v-window-item>
        </v-window>
      </v-card-text>
    </v-card>
