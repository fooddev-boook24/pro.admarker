    ...
    <div class="rank-body">
      ...
      <div class="my-box my-box-gap">
        <div class="title-box1">
          <div class="title-box1-title">【素材・構造で違いが出る】</div>
          <div
      ...
      <div class="my-box my-box-gap">
        <div class="title-box1">
          <div class="title-box1-title">【硬さ・寝心地の選び方】</div>
          <div
      ...
      <div class="my-box my-box-gap">
        <div class="title-box1">
          <div class="title-box1-title">【お試し・返品保証目安】</div>
          <div
  ...
  {{ dataStore.sec03.pageaction }}
      ...
      <div class="my-box my-box-gap">
        <div class="title-box1 merit-box">
          <div class="title-box1-title">こんな方におすすめ</div>
